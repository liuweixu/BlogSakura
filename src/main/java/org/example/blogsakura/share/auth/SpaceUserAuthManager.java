package org.example.blogsakura.share.auth;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import jakarta.annotation.Resource;
import org.example.blogsakura.domain.space.constant.SpaceUserPermissionConstant;
import org.example.blogsakura.share.auth.model.SpaceUserAuthConfig;
import org.example.blogsakura.share.auth.model.SpaceUserRole;
    ...
    public List<String> getPermissionList(Space space, User loginUser) {
        ...
        switch (spaceTypeEnum) {
            ...
            case TEAM:
                ...
                SpaceUser spaceUser = spaceUserApplicationService.queryChain()
