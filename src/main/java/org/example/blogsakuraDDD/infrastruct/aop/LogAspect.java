package org.example.blogsakuraDDD.infrastruct.aop;
...
public class LogAspect {
     ...
     */
    @Around("@annotation(org.example.blogsakuraDDD.infrastruct.aop.Log)")
    public Object recordLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (operateName != null && !operateName.isEmpty()) {
            ...
            operateLogApplicationService.save(operateLog);
