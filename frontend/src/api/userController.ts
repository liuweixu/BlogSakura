...
/** 此处后端没有提供注释 DELETE /backend/user/${param0} */
export async function removeUserById(
  ...
  const { id: param0, ...queryParams } = params;
  return request<API.BaseResponseBoolean>(`/backend/user/${param0}`, {
    method: "DELETE",
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function loginUserSession(options?: { [key: string]: any }) {
